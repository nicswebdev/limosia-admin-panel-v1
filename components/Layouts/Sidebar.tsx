                ...
                <div className="h-full bg-white dark:bg-black">
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            <img className="ml-[5px] w-36 flex-none" src="/assets/images/logo/quicco-logo-long.png" alt="logo" />
                        </Link>
                    ...
                    <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
                        <ul className="relative flex h-full flex-col space-y-0.5 p-4 py-0 font-semibold">
                            {AdminMenuItems.map((item) => {
                                const logoutCn = classNames('nav-item', {
                                    '!mt-auto': item.type === 'logout',
                                });
                                ...
                                if (item.hasChildren) {
                                    ...
                                    return (
                                        <li key={item.label} className={logoutCn}>
